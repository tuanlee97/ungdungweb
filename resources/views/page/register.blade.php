				...
				<div class="col-lg-8 offset-lg-2">
					<div class="single_post_title">Đăng Ký</div>
                        ...
                        @endif
                            ...
                            <form method="post" enctype="multipart/form-data" action="register" style="text-align: left;">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        Giới Tính<input class="form-control" placeholder="" name="gender" type="radio" value="0" checked="">Nam
                                        <input class="form-control" placeholder="" name="gender" type="radio" value="1">Nữ
                                    </div>
                                     <div class="form-group">
